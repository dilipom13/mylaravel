          ...
          <div class="row">
              ...
              <div class="row gap-y">
                ...
                <div class="col-md-6">
                  <div class="card border hover-shadow-6 mb-6 d-block">
                    <a href="#"><img class="card-img-top" src="{{ asset('img/thumb/1.jpg') }}" alt="Card image cap"></a>
                ...
                <div class="col-md-6">
                  <div class="card border hover-shadow-6 mb-6 d-block">
                <a href="#"><img class="card-img-top" src="{{ asset('img/thumb/2.jpg') }}" alt="Card image cap"></a>
                    <div class="p-6 text-center">
                ...
                <div class="col-md-6">
                  <div class="card border hover-shadow-6 mb-6 d-block">
                    <a href="#"><img class="card-img-top" src="{{ asset('img/thumb/3.jpg') }}" alt="Card image cap"></a>
                    <div class="p-6 text-center">
                ...
                <div class="col-md-6">
                  <div class="card border hover-shadow-6 mb-6 d-block">
                    <a href="#"><img class="card-img-top" src="{{ asset('img/thumb/4.jpg') }}" alt="Card image cap"></a>
                    <div class="p-6 text-center">
                ...
                <div class="col-md-6">
                  <div class="card border hover-shadow-6 mb-6 d-block">
                    <a href="#"><img class="card-img-top" src="{{ asset('img/thumb/5.jpg') }}" alt="Card image cap"></a>
                    <div class="p-6 text-center">
                ...
                <div class="col-md-6">
                  <div class="card border hover-shadow-6 mb-6 d-block">
                    <a href="#"><img class="card-img-top" src="{{ asset('img/thumb/6.jpg') }}" alt="Card image cap"></a>
                    <div class="p-6 text-center">
            ...
            <div class="col-md-4 col-xl-3">
              <div class="sidebar px-4 py-md-0">
                ...
                <a class="media text-default align-items-center mb-5" href="blog-single.html">
                  <img class="rounded w-65px mr-4" src="{{ asset('img/thumb/5.jpg') }}">
